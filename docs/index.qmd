...
[Animal sounds](https://github.com/UtrechtUniversity/animal-sounds) is a repository  that provides an end-to-end audio classification pipeline for animal vocalizations, including audio preprocessing, feature extraction, data augmentation, training, evaluation, and prediction.
