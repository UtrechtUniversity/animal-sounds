...
def extract_speech_features(signal, sr=48000):
    ...
    mfcc = rasta.melfcc(signal, fs=sr, max_freq=2000, n_mfcc=13, n_bands=12,
        fbtype='fcmel', dcttype=1, usecmp=True, window_time=0.025, hop_time=0.010,
        preemph=0, dither=1)
    ...
    # RASTA PLP
    # =========
    rplp = rasta.rastaplp(signal, fs=sr, win_time = 0.025, hop_time = 0.010, 
        dorasta = True, modelorder = 12)
