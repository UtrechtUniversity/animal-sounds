    ...
    for raven_file in all_raven_files:
        ...
        for index, row in bg.iterrows():
            ...
            if row['Begin Path'] != row['End Path']:
                ...
                for i, name in enumerate(files_involved):
                    ...
                    if i == 0:
                        ...
                        if one_file:
                            ...
                            outfile1 = str(k) + '_' + files_involved[0][0:-4] + '_' + \
                                    str(round(start_time, 6)) + '.wav'
                        ...
                        if one_file:
                            ...
                            outfile1 = str(k) + '_' + files_involved[-1][0:-4] + '_' + \
                                    str(0.0) + '.wav'
                            out_file = out_path + outfile1
                            extract.to_wav(out_file)
                        ...
                        if one_file:
                            ...
                            outfile1 = str(k) + '_' + files_involved[i][0:-4] + '_' + \
                                    str(0.0) + '.wav'
                            out_file = out_path + outfile1
                ...
                outfile1 = str(k) + '_' + Path(row['Begin Path']).name[0:-4] + '_' + \
                        str(round(start_time, 6)) + '.wav'
