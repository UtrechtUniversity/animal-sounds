...
python bioacoustics/wav_processing/synthetic_data/2_create_overview.py \
    --input_dir "$data_dir/processed_wav_files/background/zambia" \
    --output "$data_dir/synthetic_intermediate/overviews/background_zambia.json"
echo "create background mefou overview"
python bioacoustics/wav_processing/synthetic_data/2_create_overview.py \
    --input_dir "$data_dir/processed_wav_files/background/mefou_chimp_enclosure" \
    --output "$data_dir/synthetic_intermediate/overviews/background_mefou.json"
echo "generate synthetic data"
python bioacoustics/wav_processing/synthetic_data/3_create_synth_sample.py \
    --primate_json "$data_dir/synthetic_intermediate/overviews/background_mefou.json" \
    --background_json "$data_dir/synthetic_intermediate/overviews/background_zambia.json" \
